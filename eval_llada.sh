...
accelerate launch eval_llada.py --limit 2 --tasks humaneval,humaneval_plus,mbpp,mbpp_plus --output_path output/test_results --model llada_dist --confirm_run_unsafe_code --model_args model_path='GSAI-ML/LLaDA-8B-Base',gen_length=1024,steps=1024,block_length=1024
