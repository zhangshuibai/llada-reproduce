...
accelerate launch eval_llada.py --tasks humaneval,humaneval_plus --output_path output/test_results --model llada_dist --confirm_run_unsafe_code --model_args --gen_kwargs model_path='GSAI-ML/LLaDA-8B-Base',gen_length=512,steps=512,block_length=512
